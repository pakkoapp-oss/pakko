...
- ✅ Асоціація типів файлів (для кожного формату для читання). URI-протокол не реєструється (колишню схему `pakko://` прибрано), тож вебсторінка не може запустити Pakko власним посиланням
